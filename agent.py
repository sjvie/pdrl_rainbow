...
class Agent:
    ...
    def __init__(self, input_dim, action_space, num_atoms, gamma, v_min, v_max, discount_factor, batch_size):
    ...
    def train(self):
        ...
        T_zj= rewards+ self.gamma* (1-dones)*self.z_support # Tz = r + gamma*(1-done)*z_j TODO: hier ansetzen für Multistep?
    ...
    def select_action(self, state):
        """
        :param state (Tensor): Tensor with dim [input_dim]
